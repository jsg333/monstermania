...
// He landed on a fast, snappy jump: the same height as before, but it happens
// in 0.47s instead of 0.64s. "Heavy" turned out to mean sluggish, not floaty.
//
...
export const CONFIG = {
  // ---- How the world works ----
  GRAVITY: 4000,            // pixels per second, per second. Bigger = you fall faster.
  MAX_FALL_SPEED: 1400,     // you never fall faster than this
  TILE: 32,                 // how big one block is, in pixels

  // ---- Running ----
  RUN_SPEED: 320,           // top running speed
  ...
  // ---- Jumping ----
  JUMP_SPEED: 940,          // how hard you launch upward
  JUMP_CUTOFF: 0.1,        // let go early and your jump gets cut to this much. Tap = little hop.
