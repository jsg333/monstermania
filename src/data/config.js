...
export const CONFIG = {
  // ---- How the world works ----
  GRAVITY: 2200,            // pixels per second, per second. Bigger = you fall faster.
  MAX_FALL_SPEED: 1400,     // you never fall faster than this
  TILE: 32,                 // how big one block is, in pixels

  // ---- Running ----
  RUN_SPEED: 260,           // top running speed
  ...
  // ---- Jumping ----
  JUMP_SPEED: 700,          // how hard you launch upward
  JUMP_CUTOFF: 0.38,        // let go early and your jump gets cut to this much. Tap = little hop.
